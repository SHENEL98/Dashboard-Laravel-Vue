<template>
  ...
  <VaDataTable :items="paginatedUsers" :columns="columns" :loading="loading" v-model:sort-by="sortBy"
    v-model:sorting-order="sortingOrder" hoverable>
  ...
  <div class="flex flex-col-reverse md:flex-row gap-2 justify-between items-center py-2">
    ...
    <div v-if="totalPages > 1" class="flex items-center gap-2">
      <VaButton preset="secondary" icon="va-arrow-left" aria-label="Previous page" :disabled="currentPage === 1"
        @click="currentPage--" />
      <span>Page {{ currentPage }} of {{ totalPages }}</span>
      <VaButton preset="secondary" icon="va-arrow-right" aria-label="Next page" :disabled="currentPage === totalPages"
        @click="currentPage++" />
      <VaPagination v-model="currentPage" :pages="totalPages" :visible-pages="5" :boundary-links="false"
